...
<head>
  ...
  <style>
    ...
    .pipeline { display: flex; gap: 28px; overflow-x: auto; padding: 20px; scrollbar-width: thin; scrollbar-color: #334155 transparent; }
    .column {
      flex: 1; min-width: 320px;
      background: rgba(255,255,255,0.03);
      border: 1px solid rgba(255,255,255,0.08);
      border-radius: 16px; box-shadow: 0 10px 25px rgba(0,0,0,0.3);
      padding: 16px; transition: background 0.2s ease;
    }
    .column:hover { background: rgba(255,255,255,0.05); }
    .column h4 { text-align: center; color: #a5b4fc; margin-bottom: 1.2rem; font-weight: 700; letter-spacing: 0.3px; }

    .card {
      position: relative;
      background: linear-gradient(135deg, rgba(30,41,59,0.85), rgba(51,65,85,0.9));
      border-radius: 14px; margin-bottom: 14px; padding: 14px 16px;
      color: #e5e7eb; box-shadow: 0 6px 18px rgba(0,0,0,0.25);
      border: 1px solid rgba(255,255,255,0.06); cursor: grab;
      transition: all 0.25s ease; user-select: none;
    }
    .card:hover { transform: translateY(-3px); box-shadow: 0 10px 25px rgba(59,130,246,0.3); border-color: rgba(59,130,246,0.3); }
    ...
    .drag-over { border: 2px dashed #3b82f6; background-color: rgba(37,99,235,0.15); }
